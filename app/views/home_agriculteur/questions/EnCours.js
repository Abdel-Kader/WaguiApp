    ...
    { 
        NetInfo.fetch().then(state => 
        {
            ...
            { 
                ...
                axios.get(agri_api+ "getMyQuestionsEncours/"+this.state.id_agri)
                .then(response => {
                if(response.data != 'no')
                    {
            ...
            return(
                <View style={{flex:1}}>
                    ...
                    <View style={{flex:1, justifyContent: 'center', alignItems:'center'}}>
                        ...
                        <Text style={{fontSize: 23,textAlign:'center', color: colors.green1, fontWeight: 'bold'}}> Vous n'avez pas encore posé de question !</Text>
                    </View>
