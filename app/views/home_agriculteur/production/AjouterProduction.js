...
export default class AjouterProduction extends Component
{
    constructor(propos)
    {
        super(propos);
    ...
    _AddProduction(libelle, description, localisation, qte, prix_unitaire, media_1, media_2, media_3)
    {
                        ...
                        .then(res => 
                            {
                                if(res.data.message == 'Yess')
                                {
                                    ...
                                    alert("Votre production a été ajouté avec succèss");
                                }
                                else
                                {
                        ...
                        .then(res => 
                            {
                                ...
                                else
                                {
                                    ...
                                    alert("then no media "+res.data.message);
                                }
                            })
                        .catch(error =>
                            {
                ...
                <View style={style.container}>
                    ...
                    <View style={style.bodyView}>
                        ...
                        <View style={{marginTop: 30}}>
                            ...
                            <RoundedButton
                                handleNextButton={()=> this._AddProduction(libelle, description, localisation, quantite, prix_unitaire, media_1, media_2, media_3)}
                                disabled={this.toggleState()}
                                text={"Ajouter la production"}
